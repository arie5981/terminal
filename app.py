...
SYSTEM_INSTRUCTION = (
    ...
    "4. ⚠️ חובה להכליל הערות קריטיות: אם בנוהל הרלוונטי מופיעה התייחסות המוגדרת כ-'חשוב!:' (או סייג מרכזי), חובה לכלול התייחסות זו בתשובה ולהדגישה (לדוגמה: '**שים לב:** אישור מרכז לא כולל אישור מילואים...').\n\n"
    ...
    "🔗 חוקי קישורים, סוגריים מרובעים וסרטונים:\n"
    "1. ודא שכל שם של טופס, אתר, מערכת, מוקד או כתובת מייל שמופיעים בטקסט, עטופים בדיוק בסוגריים מרובעים כפי שהם מופיעים בנהלים.\n"
    "2. 🎬 סרטוני הדרכה: אם בנוהל הרלוונטי מופיע אזכור לסרטון (כגון 'סירטון: ... [שם הסרטון]'), חובה להוסיף בסוף התשובה שורה נפרדת בדיוק בנוסח: 'סרטון הדרכה: [שם הסרטון]' תוך שמירה מדויקת על השם בתוך הסוגריים המרובעים."
)
def get_debug_mode():
