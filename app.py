...
SYSTEM_INSTRUCTION = (
    ...
    "2. 🎬 סרטוני הדרכה: אם בנוהל הרלוונטי מופיע אזכור לסרטון (כגון 'סרטון: ... [שם הסרטון]'), חובה להוסיף בסוף התשובה שורה נפרדת בדיוק בנוסח: 'סרטון הדרכה: [שם הסרטון]' תוך שמירה מדויקת על השם בתוך הסוגריים המרובעים."
)
def get_debug_mode():
